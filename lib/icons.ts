export const getPlatformIcon = (platform: string, customImage?: string): string => {
    ...
    if (p.includes('snapchat')) return 'https://cdn-icons-png.flaticon.com/512/2111/2111601.png';
    ...
    // 6. Marketplace Fallbacks (Use favicons if needed)
    if (p.includes('z2u')) return 'https://www.z2u.com/favicon.ico';
    if (p.includes('g2g')) return 'https://www.g2g.com/favicon.ico';
    if (p.includes('playerup')) return 'https://www.playerup.com/favicon.ico';
