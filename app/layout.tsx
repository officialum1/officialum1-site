...
export const metadata: Metadata = {
  ...
  keywords: ["SEO Sahiwal", "Web Development Pakistan", "Buy Reddit Accounts", "Instagram Growth", "OfficialUM1", "Muhammad Umar Mumtaz", "Digital Agency", "Social Media Marketing"],
  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "founder": {
          "@type": "Person",
          "@id": "https://officialum1.com/#founder",
          "name": "Muhammad Umar Mumtaz",
          "jobTitle": "Founder & CEO",
          "image": "https://officialum1.com/founder.jpg",
          "sameAs": [
            "https://linkedin.com/in/muhammadumarmumtaz",
            "https://youtube.com/@muhammadumarmumtaz",
            "https://github.com/officialum1",
            "https://filmfreeway.com/MuhammadUmarMumtaz"
          ]
        },
        "address": {
          "@type": "PostalAddress",
        ...
        "sameAs": [
          ...
          "https://www.designrush.com/agency/profile/officialum1",
          "https://officialum1.com",
          "https://www.prlog.org/13093693-officialum1-strengthens-global-presence-with-innovative-web-development-digital-marketing-servi.html"
        ],
        "knowsAbout": [
