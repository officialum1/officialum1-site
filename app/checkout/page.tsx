                            ...
                            {[
                                ...
                                <button
                                    ...
                                    style={{
                                        ...
                                        padding: '1.5rem',
                                        borderRadius: '16px',
                                        border: paymentMethod === method.id ? '2px solid #00ff88' : '1px solid rgba(255,255,255,0.05)',
                                        background: paymentMethod === method.id ? 'rgba(0, 255, 136, 0.05)' : 'rgba(255,255,255,0.02)',
                                        color: '#fff',
                                ...
                                >
                                    {paymentMethod === method.id && <div style={{ position: 'absolute', inset: 0, background: 'radial-gradient(circle at center, rgba(0,255,136,0.15) 0%, transparent 70%)' }}></div>}
                                    <div style={{ fontSize: '2rem', marginBottom: '0.8rem', position: 'relative', zIndex: 1 }}>{method.icon}</div>
                                    <div style={{ fontWeight: 600, fontSize: '0.9rem', position: 'relative', zIndex: 1 }}>{method.name}</div>
                                    {paymentMethod === method.id && <div style={{ position: 'absolute', bottom: '10px', left: '50%', transform: 'translateX(-50%)', width: '4px', height: '4px', borderRadius: '50%', background: '#00ff88', boxShadow: '0 0 10px #00ff88' }}></div>}
                                </button>
                            ))}
