            ...
            <div style={{ paddingTop: '80px' }}>
                ...
                >
                    <div style={{ flex: '1', minWidth: '280px' }}>
                        <h2 style={{ color: '#111827', fontSize: '1.5rem', fontWeight: 'bold', marginBottom: '0.5rem' }}>Exclusive Bundle Offer</h2>
                    ...
                    <Link href="/bundles" className="btn-primary" style={{ padding: '1rem 2.5rem', fontSize: '1rem' }}>
                        Start Saving Now
                    </Link>
                </div>
                                        ...
                                        >
                                            ...
                                            <div style={{ padding: '1.5rem', flex: 1, display: 'flex', flexDirection: 'column' }}>
                                                ...
                                                <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                                                    ...
                                                    <div style={{ fontSize: '0.65rem', padding: '2px 6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', border: '1px solid rgba(255,255,255,0.1)', color: '#888' }}>Warranty</div>
                                                </div>
                                                ...
                                                <div style={{ display: 'flex', gap: '0.5rem' }}>
                                                    {totalStock > 0 ? (
                                                        ...
                                                        >
                                                            <span style={{ display: 'inline-flex', gap: '0.5rem', alignItems: 'center', justifyContent: 'center' }}>
                                                                <Bell size={16} />
                                                                Notify Me
                                                            </span>
                                                        </button>
            ...
            {showNotifyModal && (
                <div style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', background: 'rgba(0,0,0,0.85)', zIndex: 9999, display: 'flex', justifyContent: 'center', alignItems: 'center', backdropFilter: 'blur(10px)', padding: '2rem' }}>
                    <div className="glass" style={{ width: '100%', maxWidth: '500px', padding: '2.5rem', borderRadius: '24px', position: 'relative', border: '1px solid #00c3ff' }}>
                        <button onClick={() => setShowNotifyModal(false)} style={{ position: 'absolute', top: '20px', right: '20px', background: 'none', border: 'none', color: '#888', cursor: 'pointer' }} aria-label="Close">
                            <X size={22} />
                        </button>
