...
export default function PaymentSettings() {
    ...
    return (
        <main className="min-h-screen bg-black text-white">
            <Navbar />
            <div className="container mx-auto px-4" style={{ paddingTop: '120px', paddingBottom: '100px', maxWidth: '800px' }}>
                <h1 className="text-4xl font-bold mb-2 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-green-400">
                    Payment Processors
                </h1>
                <p className="text-gray-400 mb-8">Configure your payment gateways and API keys.</p>
