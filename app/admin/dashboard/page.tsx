    ...
    return (
        <AdminShell title="Dashboard" subtitle="Live analytics and operational overview.">
            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', marginBottom: '1.25rem' }}>
                <a href="/admin/inventory" className="btn-secondary">Workspace</a>
                <a href="/admin/users" className="btn-secondary">Users</a>
                <a href="/admin/reviews" className="btn-secondary">Reviews</a>
                <a href="/admin/coupons" className="btn-secondary">Coupons</a>
                <a href="/admin/newsletter" className="btn-secondary">Newsletter</a>
                <a href="/admin/payouts" className="btn-secondary">Payouts</a>
                <a href="/admin/blogs" className="btn-secondary">Blogs</a>
