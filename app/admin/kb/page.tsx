        ...
        <main>
            ...
            <div className="container" style={{ paddingTop: '150px', paddingBottom: '100px' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                    <h1 style={{ fontFamily: 'var(--font-outfit)', fontSize: '2.5rem' }}>📚 Knowledge Base</h1>
                    <button onClick={() => { setShowModal(true); setEditingId(null); setForm({ title: '', slug: '', category: 'General', content: '', is_published: true }); }} className="btn btn-primary">
                        + New Article
                    </button>
                </div>
                        ...
                        <tbody>
                            {articles.map(a => (
                                <tr key={a.id} style={{ borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                                    ...
                                    <td style={{ padding: '1rem' }}>
                                        <button onClick={() => handleEdit(a)} className="btn btn-outline" style={{ fontSize: '0.8rem', padding: '0.4rem 0.8rem', marginRight: '0.5rem' }}>Edit</button>
                                        <button onClick={() => handleDelete(a.id)} className="btn btn-outline" style={{ fontSize: '0.8rem', padding: '0.4rem 0.8rem', borderColor: '#ff4444', color: '#ff4444' }}>Delete</button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
