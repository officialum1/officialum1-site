...
export default function DeliveryPage() {
    ...
    return (
        <main style={{ minHeight: '100vh', background: '#020202', color: '#fff', fontFamily: "'Outfit', sans-serif", backgroundImage: 'radial-gradient(circle at 50% -20%, #1a1a1a 0%, #020202 60%)', position: 'relative' }}>
            <Navbar />
            ...
            {showCheckIn && (
                <div style={{
                    ...
                    <div className="fade-in-scale" style={{
                        background: 'linear-gradient(145deg, #111, #0a0a0a)', border: '1px solid rgba(255,255,255,0.1)',
                        borderRadius: '32px', padding: '4rem', maxWidth: '600px', width: '100%',
                        textAlign: 'center', boxShadow: '0 40px 100px rgba(0,0,0,0.8)'
                    }}>
                        {feedbackStatus === 'prompt' && (
                            <>
                                <div style={{ fontSize: '4rem', marginBottom: '1rem' }}>👋</div>
                                <h2 style={{ fontSize: '2.5rem', fontWeight: '800', marginBottom: '1rem' }}>How is everything working?</h2>
                                <p style={{ color: '#888', fontSize: '1.1rem', marginBottom: '3rem', lineHeight: '1.6' }}>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                                    <button
                                        ...
                                        style={{ background: '#00ff88', color: '#000', border: 'none', padding: '1.2rem', borderRadius: '16px', fontSize: '1.2rem', fontWeight: '700', cursor: 'pointer', transition: 'transform 0.2s' }}
                                    ...
                                    <button
                                        ...
                                        style={{ background: 'rgba(255,255,255,0.05)', color: '#fff', border: '1px solid rgba(255,255,255,0.1)', padding: '1.2rem', borderRadius: '16px', fontSize: '1.1rem', fontWeight: '600', cursor: 'pointer' }}
                                    >
                        ...
                        {feedbackStatus === 'happy' && (
                            <>
                                <div style={{ fontSize: '4rem', marginBottom: '1rem' }}>⭐</div>
                                <h2 style={{ fontSize: '2.5rem', fontWeight: '800', marginBottom: '1rem' }}>Awesome! Could you do us a huge favor?</h2>
                                <p style={{ color: '#aaa', fontSize: '1.1rem', marginBottom: '2rem', lineHeight: '1.6' }}>
                                ...
                                <button
                                    ...
                                    style={{ display: 'block', width: '100%', textDecoration: 'none', background: '#00ff88', color: '#000', padding: '1.2rem', borderRadius: '16px', fontSize: '1.2rem', fontWeight: '800', marginBottom: '1rem', boxShadow: '0 0 30px rgba(0,255,136,0.3)', cursor: 'pointer' }}
                                >
                                    ⭐ Click Here to leave a Site Review! ⭐
                                </button>
                                <button onClick={() => setShowCheckIn(false)} style={{ background: 'none', border: 'none', color: '#666', cursor: 'pointer', textDecoration: 'underline' }}>
                        ...
                        {feedbackStatus === 'problem' && (
                            <>
                                ...
                                <h2 style={{ fontSize: '2.2rem', fontWeight: '800', marginBottom: '1rem', color: '#fff' }}>Let's get this fixed.</h2>
                                <p style={{ color: '#aaa', fontSize: '1.1rem', marginBottom: '2rem', lineHeight: '1.6' }}>
                                ...
                                <textarea
                                    ...
                                    style={{ width: '100%', background: 'rgba(0,0,0,0.5)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '12px', padding: '1rem', color: '#fff', minHeight: '120px', marginBottom: '1rem', fontFamily: 'inherit' }}
                                ></textarea>
                                <button
                                    onClick={() => {
                                    ...
                                    style={{ width: '100%', background: '#fff', color: '#000', border: 'none', padding: '1.2rem', borderRadius: '16px', fontSize: '1.1rem', fontWeight: '700', cursor: 'pointer', marginBottom: '1rem' }}
                                >
            ...
            <div className="container" style={{ paddingTop: '140px', paddingBottom: '120px', maxWidth: '900px', margin: '0 auto', paddingLeft: '1.5rem', paddingRight: '1.5rem' }}>
                                                    ...
                                                    {bulkAccounts.map((acc: any, i: number) => (
                                                        <tr key={i} className="row-item">
                                                            ...
                                                            {bulkAccounts.some(a => a.emailPass) && (
                                                                <td style={{ padding: '1.2rem 1.5rem' }}>
                                                                    <div style={{ color: '#fff', fontFamily: 'monospace' }}>{acc.emailPass || '---'}</div>
                                                                </td>
                                                            )}
                                                            {bulkAccounts.some(a => a.country) && (
                                                                <td style={{ padding: '1.2rem 1.5rem' }}>
                                                                    <div style={{ color: '#aaa', fontWeight: 'bold' }}>{acc.country || '---'}</div>
                                                                </td>
                                                            )}
                                            ...
                                            {order.details.extraInfo ? (
                                                ...
                                                <div style={{ display: 'grid', gap: '1.5rem' }}>
                                                    ...
                                                    {order.details.emailPassword && (
                                                        <div className="credential-field">
                                                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
                                                                <label style={{ fontSize: '0.7rem', color: '#444', letterSpacing: '2px', fontWeight: '700', textTransform: 'uppercase' }}>Email Access Key</label>
                                                                <span style={{ fontSize: '0.65rem', color: '#aaa' }}>MAIL PASSWORD</span>
                                                            </div>
                                                            <div style={{ display: 'flex', gap: '1rem', background: 'rgba(255,255,255,0.02)', padding: '0.8rem', borderRadius: '20px', border: '1px solid rgba(255,255,255,0.05)' }}>
                                                                <div style={{ flex: 1, padding: '1rem', fontSize: '1.1rem', fontFamily: 'monospace', color: '#fff', letterSpacing: '2px' }}>
                                                                    {order.details.emailPassword}
                                                    ...
                                                    {order.details.country && (
                                                        <div className="credential-field">
                                                            <div style={{ marginBottom: '1rem' }}>
                                                                <label style={{ fontSize: '0.7rem', color: '#444', letterSpacing: '2px', fontWeight: '700', textTransform: 'uppercase' }}>Account Origin</label>
                                                            </div>
                                                            <div style={{ display: 'flex', gap: '1rem', background: 'rgba(255,255,255,0.02)', padding: '1rem', borderRadius: '20px', border: '1px solid rgba(255,255,255,0.05)', color: '#aaa', fontWeight: 'bold' }}>
                                                                🌍 Registered in: {order.details.country}
                                                            </div>
                                                        </div>
                                                    )}
                                                </div>
                ...
                {revealed && !reviewSubmitted && (
                    <div id="review-section" className="premium-card fade-in" style={{ marginTop: '3rem', padding: '3rem', borderRadius: '32px', textAlign: 'center', background: 'rgba(255,255,255,0.01)', border: '1px solid rgba(255,255,255,0.03)' }}>
