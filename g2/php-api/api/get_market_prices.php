...
if ($method === 'GET') {
    // Get productId from query parameter (set by router)
    $productId = getQueryParam('productId', null);
    ...
    $signaturePath = '/v2/products/' . $productId . '/market-prices';
    $urlPath = '/products/' . $productId . '/market-prices';
