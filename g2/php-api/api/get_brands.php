...
if ($method === 'GET') {
    // Get serviceId from query parameter (set by router)
    $serviceId = getQueryParam('serviceId', null);
    ...
    $signaturePath = '/v2/services/' . $serviceId . '/brands';
    $urlPath = '/services/' . $serviceId . '/brands';
