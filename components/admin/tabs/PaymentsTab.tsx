                        ...
                        <div style={{ display: 'grid', gap: '2rem' }}>
                            <div className="glass" style={{ padding: '2.5rem', borderRadius: '32px' }}>
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1.5rem' }}>
                                    {[
                                        { label: 'Binance Wallet', val: `$ ${stats.wallets?.binance?.toFixed(2) || '0.00'}` },
                                        { label: 'RedotPay Wallet', val: `$ ${stats.wallets?.redotpay?.toFixed(2) || '0.00'}` },
                            ...
                            <div className="glass" style={{ padding: '2.5rem', borderRadius: '32px' }}>
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '1rem', marginBottom: '1.5rem' }}>
                                    <select className="input-field" value={fundForm.platform} onChange={e => setFundForm({ ...fundForm, platform: e.target.value })}>
                                        ...
                                        <option value="Binance" style={{ color: 'black' }}>Binance</option>
                                        <option value="RedotPay" style={{ color: 'black' }}>RedotPay</option>
                                    </select>
