...
export default function StockTab({
    ...
    const handleEditClick = (item: any) => {
        ...
        if (item.accountDetails) {
            try {
                details = typeof item.accountDetails === 'string' ? JSON.parse(item.accountDetails) : item.accountDetails;
        ...
        setEditingItem({
            ...
            country: details.country || item.account_region || '',
        ...
        try {
            const res = await fetch('/api/admin/inventory', {
                ...
                body: JSON.stringify({
                    ...
                    emailPassword: editingItem.emailPassword,
                    country: editingItem.country,
                    extraInfo: editingItem.extraInfo,
                    tag: editingItem.tag,
                ...
                {showAddInv && (
                    <div className="glass" style={{ padding: '2rem', marginBottom: '2rem', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.2)', marginTop: '2rem' }}>
                        ...
                        <form onSubmit={handleAddInventory} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                            <div><label>Platform</label><select className="input-field" value={newItem.platform} onChange={e => setNewItem({ ...newItem, platform: e.target.value })} style={{ width: '100%', background: '#111', color: '#fff' }}>                                    <option value="Direct">Direct Sale</option>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', gridColumn: 'span 2' }}>
                                <div style={{ gridColumn: 'span 2' }}>
                                    <label style={{ color: '#00ff88', fontWeight: 'bold' }}>🔐 Account Login Credentials</label>
                                </div>
                                <div>
                                    <label style={{ fontSize: '0.8rem', color: '#888' }}>Account Username</label>
                                    <input
                                        type="text"
                                        className="input-field"
                                ...
                                <div>
                                    <label style={{ fontSize: '0.8rem', color: '#888' }}>Account Password</label>
                                    <input
                                        type="text"
                                        className="input-field"
                                ...
                                <div>
                                    <label style={{ fontSize: '0.8rem', color: '#888' }}>Email Password</label>
                                    <input
                                        type="text"
                                        className="input-field"
                                        value={newItem.emailPassword || ''}
                                        onChange={e => setNewItem({ ...newItem, emailPassword: e.target.value })}
                                        style={{ width: '100%', background: '#111' }}
                                    />
                                </div>
                                <div>
                                    <label style={{ fontSize: '0.8rem', color: '#888' }}>Registration Country (e.g. US, TR)</label>
                                    <input
                                        type="text"
                                        className="input-field"
                                        value={newItem.country || ''}
                                        onChange={e => setNewItem({ ...newItem, country: e.target.value })}
                                        placeholder="Turkey, USA, etc."
                                        style={{ width: '100%', background: '#111' }}
                                    />
                                </div>
                                <div style={{ gridColumn: 'span 2' }}>
                                    <label style={{ fontSize: '0.8rem', color: '#888' }}>Other Info / Extra Details</label>
                                    <textarea
                                        className="input-field"
                ...
                {showEditItem && editingItem && (
                    <div className="glass" style={{ padding: '2rem', marginBottom: '2rem', borderRadius: '16px', border: '1px solid #00b4ff', marginTop: '2rem' }}>
                        ...
                        <form onSubmit={handleUpdateInventory} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', gridColumn: 'span 2' }}>
                                <div style={{ gridColumn: 'span 2' }}>
                                    <label style={{ color: '#00b4ff', fontWeight: 'bold' }}>🔐 Account Login Credentials</label>
                                </div>
                                <div>
                                    <label style={{ fontSize: '0.8rem', color: '#888' }}>Account Username</label>
                                    <input
                                        ...
                                        style={{ width: '100%', background: 'rgba(0,180,255,0.05)' }}
                                    />
                                </div>
                                <div>
                                    <label style={{ fontSize: '0.8rem', color: '#888' }}>Account Password</label>
                                ...
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        className="input-field"
                                        value={editingItem.emailPassword || ''}
                                        onChange={e => setEditingItem({ ...editingItem, emailPassword: e.target.value })}
                                        style={{ width: '100%', background: 'rgba(0,180,255,0.05)' }}
                                    />
                                </div>
                                <div>
                                ...
                                <div style={{ gridColumn: 'span 2' }}>
                                    ...
                                    <textarea
                                        className="input-field"
                                        value={editingItem.extraInfo || ''}
                                        onChange={e => setEditingItem({ ...editingItem, extraInfo: e.target.value })}
                                        style={{ width: '100%', height: '80px', background: 'rgba(0,180,255,0.05)' }}
                                        placeholder="Any additional notes for the buyer..."
                                    />
                                </div>
                            </div>
