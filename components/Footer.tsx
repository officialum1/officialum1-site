    ...
    return (
        ...
        >
            ...
            <div className="container relative z-10">
                ...
                <div className="mt-12 flex flex-col xl:flex-row xl:items-center xl:justify-between gap-6 text-[13px] text-gray-500 mx-4 md:mx-0">
                    <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-8">
                        <div className="font-medium text-gray-400 flex items-center gap-2 whitespace-nowrap">
                        ...
                        <div className="flex flex-wrap items-center gap-4 text-xs text-gray-500">
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2">
                                <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/[0.02] border border-white/5 whitespace-nowrap">
                                ...
                                <div className="flex items-center gap-2 flex-wrap">
                                    <a href="mailto:hello@officialum1.com" className="flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/[0.02] border border-white/5 hover:bg-white/[0.05] hover:border-white/10 hover:text-gray-300 transition-all whitespace-nowrap">
                                    ...
                                    <a href="tel:+923237102924" className="flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/[0.02] border border-white/5 hover:bg-white/[0.05] hover:border-white/10 hover:text-gray-300 transition-all whitespace-nowrap">
