        ...
        >
            ...
            <div className="container relative z-10">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-12 gap-12 lg:gap-8 pb-16 border-b border-white/5 mx-4 md:mx-0">
                    ...
                    {/* Links Grid Cluster */}
                    <div className="col-span-2 md:col-span-1 lg:col-span-3 lg:ml-auto">
                        ...
                        <ul className="space-y-3.5 text-[13.5px]">
                            {[
                                ...
                                { name: 'Press Release Syndication', href: '/services/press-release-distribution' },
                                { name: 'Local SEO Citations', href: '/services/local-citations' },
                                { name: 'Speed Optimization 90+', href: '/services/wordpress-speed-optimization' },
                    ...
                    <div className="col-span-2 md:col-span-1 lg:col-span-3 lg:ml-auto">
                        ...
                        <div className="grid grid-cols-1 gap-y-3.5 text-[13.5px]">
                            {[
                                ...
                                { name: 'Backlink Domain Checker', href: '/backlink-checker' },
                ...
                {/* Master Bottom Bar */}
                <div className="mt-14 pt-8 border-t border-[var(--border-subtle)] space-y-6">
                    {/* Row 1: Official Corporate Entity & Contact Badges */}
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                        <div className="flex items-center gap-2.5 px-4 py-2 rounded-full bg-gray-50/80 border border-gray-100 text-xs font-medium text-gray-600 w-fit">
                            <svg className="w-3.5 h-3.5 text-gray-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                            <span>1001 South Main Street, Suite 600, Kalispell, MT 59901, USA</span>
                        </div>

                        <div className="flex items-center gap-3 flex-wrap">
                            <a href="mailto:hello@officialum1.com" className="flex items-center gap-2 px-4 py-2 rounded-full bg-gray-50/80 border border-gray-100 text-xs font-medium text-gray-700 hover:text-[var(--accent-blue)] hover:border-blue-200 transition-all">
                                <svg className="w-3.5 h-3.5 text-gray-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                                <span>hello@officialum1.com</span>
                            </a>
                            <a href="tel:+923237102924" className="flex items-center gap-2 px-4 py-2 rounded-full bg-gray-50/80 border border-gray-100 text-xs font-medium text-gray-700 hover:text-[var(--accent-blue)] hover:border-blue-200 transition-all">
                                <svg className="w-3.5 h-3.5 text-gray-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                                <span>+92 323 7102924</span>
                            </a>
                        </div>
                    </div>

                    {/* Row 2: Copyright & Policies */}
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 pt-4 border-t border-gray-100/80 text-[12.5px] text-gray-500">
                        <div className="flex items-center gap-2 font-medium">
                            <span>© {new Date().getFullYear()} OfficialUM1 LLC.</span>
                            <span className="text-gray-300">&bull;</span>
                            <span className="text-emerald-700 font-bold">US Registered Entity</span>
                            <span className="text-gray-300">&bull;</span>
                        ...
                        <div className="flex items-center justify-between md:justify-end gap-6 flex-wrap">
                            ...
                            <button 
                                ...
                                className="flex items-center justify-center h-8 w-8 rounded-xl bg-gray-50 border border-gray-200 text-gray-500 hover:bg-[var(--accent-blue)] hover:text-white hover:border-[var(--accent-blue)] transition-all shadow-sm shrink-0"
                            >
