                ...
                .then(data => {
                    ...
                    if (data.payment_gateways) {
                        try {
                            ...
                            if (data.enable_stripe === undefined) updatedMethods.stripe = pg.stripe !== false;
                            if (data.enable_cryptomus === undefined) updatedMethods.crypto = pg.crypto !== false;
                            if (data.enable_binance === undefined) updatedMethods.binance = pg.binance !== false;
                        } catch { }
                    }
