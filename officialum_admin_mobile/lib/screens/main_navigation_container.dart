...
class _MainNavigationContainerState extends State<MainNavigationContainer> {
  ...
  Widget _getScreen(bool isAuthenticated) {
    ...
    switch (_selectedIndex) {
      ...
      case 8: return const Z2UHubScreen();
              ...
              child: ListView(
                ...
                children: [
                  ...
                  if (auth.isAuthenticated) ...[
                    ...
                    _buildDrawerItem('Record Physical Sale', Icons.add_circle_outline, 22),
                    
                    const SizedBox(height: 15),
                    _buildSectionHeader('PLATFORM ENGINES'),
                    _buildDrawerItem('G2G Manager', Icons.sports_esports, 3),
                    _buildDrawerItem('PlayerUp Bumper', Icons.bolt, 7),
                    _buildDrawerItem('Z2U Sync', Icons.sync, 8),
