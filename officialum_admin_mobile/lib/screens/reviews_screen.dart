...
class _ReviewsScreenState extends State<ReviewsScreen> {
  ...
  Future<void> _fetchReviews() async {
    ...
    try {
      final res = await _api.get('/testimonials');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('VERIFIED CLIENT REVIEWS', style: TextStyle(letterSpacing: 1.5, fontWeight: FontWeight.w900, fontSize: 14)),
              ...
              children: [
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text("Over 5,000+ Completed Orders", style: TextStyle(color: Colors.grey.shade400, fontSize: 11, fontWeight: FontWeight.bold)),
                        ],
                      ),
                      ElevatedButton.icon(
                        ...
                        label: const Text("WRITE REVIEW", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 11)),
                      ),
                    ],
                  ),
                ),
                ...
                if (_reviews.isEmpty)
                  Container(
                    ...
                    child: const Text("No reviews found yet. Be the first to leave feedback!", style: TextStyle(color: Colors.grey)),
                  )
                else
                  ..._reviews.map((review) {
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text(review['name'] ?? 'Verified Client', style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 14)),
                              Row(
                                children: List.generate(5, (idx) => Icon(
                                  Icons.star,
                                  size: 13,
                                  color: idx < rating ? Colors.amber : Colors.grey.shade800,
                                )),
                              ),
                            ],
                          ),
                          ...
                          Row(
                            children: [
                              ...
                              Text("Verified OfficialUM1 Buyer", style: TextStyle(color: Colors.grey.shade500, fontSize: 10)),
                            ],
                          ),
                        ],
                      ),
