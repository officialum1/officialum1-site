...
class _ClientOrdersScreenState extends State<ClientOrdersScreen> {
    ...
    try {
      ...
      if (res.statusCode == 200) {
        ...
        if (data != null && data['success'] == true) {
          ...
          setState(() => _errorMessage = data['error'] ?? "Delivery record not found. Please check your token.");
        }
      } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('MY PURCHASES & TRACKING', style: TextStyle(letterSpacing: 1.5, fontWeight: FontWeight.w900, fontSize: 14)),
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  "Enter the secure delivery token or invoice link you received after payment to unlock your credentials.",
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: _isSearching
                        ...
                        : const Text("UNLOCK MY DELIVERIES", style: TextStyle(color: Colors.black, fontWeight: FontWeight.w900, fontSize: 12, letterSpacing: 1)),
                  ),
                ),
              ],
            ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(color: const Color(0xFF00FF88).withOpacity(0.1), borderRadius: BorderRadius.circular(6)),
                  ...
                  ElevatedButton.icon(
                    style: ElevatedButton.styleFrom(backgroundColor: Colors.white.withOpacity(0.08), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8))),
                    onPressed: () {
          ...
          const Text("CUSTOMER ASSISTANCE & WARRANTY", style: TextStyle(color: Colors.grey, fontSize: 10, fontWeight: FontWeight.bold, letterSpacing: 1.5)),
